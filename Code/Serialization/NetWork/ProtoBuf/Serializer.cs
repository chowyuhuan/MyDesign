...
namespace ProtoBuf
{
        ...
        class Serializer
    {
        ...
        public static object Deserialize(Stream source, System.Type type)
        {
        ...
        public static void Serialize(Stream destination, object obj)
        {
            RuntimeTypeModel.Default.Serialize(destination, obj);
        }
        /// <summary>
